...
def cost(n, growth):
    ...
    if growth == "exponential": return "too_large" if n>=64 else float(2**n)
...
if __name__=="__main__":
    ...
    a=p.parse_args()
    result={"n":a.n,**{g:cost(a.n,g) for g in ["constant","log","linear","n_log_n","quadratic","cubic","exponential"]}}
