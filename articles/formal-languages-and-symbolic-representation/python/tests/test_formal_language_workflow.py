...
from formal_language.workflow import FormalLanguageCase, representation_quality, representation_risk
from calculators.representation_quality_calculator import compute


def test_representation_scores_in_range():
    case = FormalLanguageCase("Test", "Context", "Structure", 0.8, 0.8, 0.8, 0.75, 0.75, 0.75, 0.7, 0.75, 0.7, 0.7)
